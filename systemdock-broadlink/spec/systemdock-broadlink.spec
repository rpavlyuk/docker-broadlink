...
Summary:	SystemDock profile to run BroadLink container as systemd service

Group:		Tools/Other
License:	GPLv3
URL:		https://github.com/rpavlyuk/docker-broadlink
...
%description
SystemDock profile to run BroadLink container as systemd service
